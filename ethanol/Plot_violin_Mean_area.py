...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 10 15:27:10 2023
...
sns.violinplot(x=df_filtered["group"],
               ...
               order=group_order,
               ax=axes[0])
axes[0].set_ylabel("Neun mean area", weight='bold')
...
sns.violinplot(x=df_filtered["group"],
               ...
               order=group_order,
               ax=axes[1])
axes[1].set_ylabel("GFAP mean area", weight='bold')
...
sns.violinplot(x=df_filtered["group"],
               ...
               order=group_order,
               ax=axes[2])
axes[2].set_ylabel("Iba mean area", weight='bold')
...
# Save the plot
plot_file = f"{plot_path}{region}_combined_violinplots.png"
